...
centerLogo.Image = "rbxassetid://80331638155006"
centerLogo.Parent = screenGui
...
toggleButton.Image = "rbxassetid://80331638155006"
    ...
    elseif World3 then
        ...
        elseif MyLevel == 2525 or MyLevel <= 2550 then
           ...
           elseif MyLevel == 2550 or MyLevel <= 2574 then
            ...
            CFrameQuest = CFrame.new(-16665.1914, 104.596405, 1579.69434, 0.951068401, -0, -0.308980465, 0, 1, -0, 0.308980465, 0, 0.951068401)
            CFrameMon = CFrame.new(-16654.7754, 105.286232, 1579.67444, 0.999096751, 4.45934489e-08, 0.0424928814, -4.38822667e-08, 1, -1.76692847e-08, -0.0424928814, 1.57886415e-08, 0.999096751)
            elseif MyLevel == 2601 or MyLevel <= 2749 then
            Mon = "Sea Chanter"
            LevelQuest = 1
            NameQuest = "Submerged"
            NameMon = "Sea Chanter"
            CFrameQuest = CFrame.new(10876.6533, -2086.19922, 10033.416, -0.499931514, 6.16107414e-08, -0.866064966, 1.21403218e-07, 1, 1.05932496e-09, 0.866064966, -1.04613484e-07, -0.499931514)
            CFrameMon = CFrame.new(10588.749, -2087.72339, 10116.7617, -0.324652582, -9.21362653e-10, 0.945833325, 7.94128763e-10, 1, 1.24670874e-09, -0.945833325, 1.15586063e-09, -0.324652582)
        end
    end
end
...
Module.FastAttack = (function()
    ...
    task.spawn(function()
        while task.wait(Settings.ClickDelay or 0.0001) do
            if (tick() - Module.AttackCooldown) < 0.05 then continue end
...
_G.UltraLowGraphics = true

spawn(function()
    while _G.UltraLowGraphics do
        task.wait(2)
